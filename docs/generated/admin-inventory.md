...
- **Feature modules:** **119** files in `app/modules/` (**110** routed), **133,159** lines combined
...
| `modules/consignment.js` | 2,311 | galleries |
...
| `modules/sales.js` | 3,363 | pos, receipts, events, salesEvents, terms |
