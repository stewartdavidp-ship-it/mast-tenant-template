...
- **Core shell:** `app/index.html` — **59,691** lines
- **Feature modules:** **98** files in `app/modules/` (**89** routed), **114,393** lines combined
...
| `modules/products-v2.js` | 3,373 | products-v2 |
