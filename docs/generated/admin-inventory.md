...
- **Core shell:** `app/index.html` — **58,908** lines
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **108,690** lines combined
...
| `modules/maker.js` | 6,836 | materials, products |
...
| `modules/products-v2.js` | 831 | products-v2 |
