...
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **108,156** lines combined
...
| `modules/products-v2.js` | 473 | products-v2 |
...
| `modules/workflows/workflow-engine.js` | 1,178 | — |
