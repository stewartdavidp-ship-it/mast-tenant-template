...
- **Core shell:** `app/index.html` — **59,014** lines
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **110,822** lines combined
...
| `modules/maker.js` | 7,163 | materials, products |
...
| `modules/products-v2.js` | 2,636 | products-v2 |
