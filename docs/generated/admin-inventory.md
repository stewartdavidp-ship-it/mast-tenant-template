...
- **Core shell:** `app/index.html` — **61,210** lines
- **Feature modules:** **119** files in `app/modules/` (**109** routed), **142,819** lines combined
...
| `modules/connections-providers.js` | 1,155 | — |
...
| `modules/jobs-v2.js` | 1,299 | jobs-v2 |
...
| `modules/orders-v2.js` | 1,152 | orders-v2 |
| `modules/orders.js` | 6,775 | orders, commissions, rma |
