...
- **Core shell:** `app/index.html` — **40,184** lines
- **Feature modules:** **153** files in `app/modules/` (**91** routed), **145,135** lines combined
...
| `modules/orders-v2.js` | 1,456 | orders-v2, orders |
