...
- **Core shell:** `app/index.html` — **59,031** lines
- **Feature modules:** **97** files in `app/modules/` (**89** routed), **113,208** lines combined
...
| `modules/jobs-v2.js` | 313 | jobs-v2 |
...
| `modules/procurement-v2.js` | 837 | procurement-v2 |
