...
- **Core shell:** `app/index.html` — **49,795** lines
- **Feature modules:** **147** files in `app/modules/` (**109** routed), **159,511** lines combined
...
| `modules/advisor-v2.js` | 1,401 | advisor-v2 |
...
| `modules/finance.js` | 8,594 | finance-revenue, finance-expenses, finance-pl, finance-cash-flow, finance-ar, finance-ap, finance-tax, finance-reports, customer-portfolio, financials, finance-period-close, finance-amendments |
...
| `modules/orders-v2.js` | 1,172 | orders-v2 |
| `modules/orders.js` | 6,789 | orders, commissions, rma |
...
| `modules/team-v2.js` | 763 | team-v2 |
| `modules/team.js` | 3,388 | team |
...
| `modules/website.js` | 3,480 | website |
