...
- **Feature modules:** **119** files in `app/modules/` (**110** routed), **129,429** lines combined
...
| `modules/newsletter.js` | 2,486 | newsletter |
...
| `modules/production.js` | 3,668 | jobs, production, stories, forecast |
...
| `modules/students-config-v2.js` | 659 | students-config-v2 |
| `modules/students-v2.js` | 784 | students-v2 |
| `modules/students.js` | 1,651 | students |
