...
- **Core shell:** `app/index.html` — **61,214** lines
- **Feature modules:** **121** files in `app/modules/` (**111** routed), **145,510** lines combined
...
| `modules/connections-providers.js` | 1,157 | — |
