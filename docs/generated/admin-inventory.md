...
- **Core shell:** `app/index.html` — **59,719** lines
- **Feature modules:** **98** files in `app/modules/` (**89** routed), **114,428** lines combined
...
| `modules/orders-v2.js` | 227 | orders-v2 |
| `modules/orders.js` | 6,282 | orders, commissions, rma |
