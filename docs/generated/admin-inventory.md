...
- **Core shell:** `app/index.html` — **59,007** lines
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **109,476** lines combined
...
| `modules/maker.js` | 6,989 | materials, products |
...
| `modules/products-v2.js` | 1,464 | products-v2 |
