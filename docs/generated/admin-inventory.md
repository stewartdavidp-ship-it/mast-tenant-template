...
- **Core shell:** `app/index.html` — **58,984** lines
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **108,970** lines combined
...
| `modules/maker.js` | 6,902 | materials, products |
...
| `modules/products-v2.js` | 1,045 | products-v2 |
