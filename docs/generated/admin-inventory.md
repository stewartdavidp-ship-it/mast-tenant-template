...
- **Core shell:** `app/index.html` — **60,198** lines
- **Feature modules:** **118** files in `app/modules/` (**109** routed), **124,922** lines combined
...
| `modules/book.js` | 6,294 | book, book-detail, enrollments, instructors, instructor-detail, resources, resource-detail, passes, pass-detail, calendar, book-reports |
...
| `modules/classes-v2.js` | 923 | classes-v2, book-reports-v2, classes-rooms-v2 |
...
| `modules/finance.js` | 8,374 | finance-revenue, finance-expenses, finance-pl, finance-cash-flow, finance-ar, finance-ap, finance-tax, finance-reports, customer-portfolio, financials, finance-period-close, finance-amendments |
