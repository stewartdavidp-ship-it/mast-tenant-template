...
- **Core shell:** `app/index.html` — **40,134** lines
- **Feature modules:** **153** files in `app/modules/` (**91** routed), **144,577** lines combined
...
| `modules/website-v2.js` | 4,621 | website-v2, website, homepage, brand |
