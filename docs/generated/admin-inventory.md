...
- **Feature modules:** **94** files in `app/modules/` (**87** routed), **109,226** lines combined
...
| `modules/maker.js` | 6,963 | materials, products |
...
| `modules/products-v2.js` | 1,240 | products-v2 |
