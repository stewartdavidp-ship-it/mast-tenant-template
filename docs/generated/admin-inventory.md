...
- **Core shell:** `app/index.html` — **61,204** lines
- **Feature modules:** **119** files in `app/modules/` (**109** routed), **142,341** lines combined
...
| `modules/connections-providers.js` | 1,133 | — |
...
| `modules/orders-v2.js` | 1,023 | orders-v2 |
| `modules/orders.js` | 6,683 | orders, commissions, rma |
