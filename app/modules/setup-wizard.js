  ...
  gapRows.forEach(function(row) {
    ...
    if (isPaid) {
      ...
      if (linkTarget === 'settings-payments') {
        ...
        h += '<div style="margin-top:6px;"><a href="#" onclick="event.preventDefault(); wizardComplete(); setTimeout(function(){ navigateTo(\'website-import\'); }, 300);" style="font-size:0.85rem;color:var(--teal);text-decoration:none;">' + esc(linkLabel) + ' &rarr;</a></div>';
      }
