...
const MODULE_GATE_BASELINE = new Set([
  ...
  // procurement.js RETIRED (T6): its ProcurementBridge + VendorsBridge engine absorbed
  // into procurement-v2.js, which is can()-gated (CHECK C) — no entry needed.
  'promotions.js', 'social.js',
