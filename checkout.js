...
(function () {
  ...
  function attachPlacesAutocomplete() {
    ...
    if (google.maps.places.PlaceAutocompleteElement) {
      ...
      var innerInput = pac.querySelector('input');
      if (innerInput) innerInput.style.cssText = input.style.cssText;
  ...
  function fillAddressFromPlace(place) {
    // Support both old (address_components/long_name/short_name) and new (addressComponents/longText/shortText) API
    ...
    // New PlaceAutocompleteElement replaces the input, so also set via PAC element
